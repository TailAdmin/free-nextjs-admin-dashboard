...
import { TwitterIcon, TwitterIconHandle } from "../ui/twitter-icon/TwitterIcon";
import { FacebookIcon, FacebookIconHandle } from "../ui/facebook-icon/FacebookIcon";
import { LinkedInIcon, LinkedInIconHandle } from "../ui/linkedin-icon/LinkedInIcon";
import { InstagramIcon, InstagramIconHandle } from "../ui/instagram-icon/InstagramIcon";

export default function UserMetaCard() {
  const { isOpen, openModal, closeModal } = useModal();
  const twitterRef = useRef<TwitterIconHandle>(null);
  const facebookRef = useRef<FacebookIconHandle>(null);
          ...
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            ...
            <div className="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
              <a
                ...
                onMouseEnter={() => facebookRef.current?.startAnimation()}
                onMouseLeave={() => facebookRef.current?.stopAnimation()}
              >
                <FacebookIcon ref={facebookRef} size={20} />
              </a>
