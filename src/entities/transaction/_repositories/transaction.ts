...
import { convertTimeStampToLocaleDateString, convertISODateToLocaleDateString } from '@/shared/utils/commonUtils';
...
export class TransactionsRepository {
    ...
    async getTransactionsByFilter(page:number, pageSize:number, filter: Record<string, any>): Promise<{data: Transaction[], total: number}> {
        ...
        const filterFields = [
            'user_id', 'player_id', 'user_name',
            'player_name', 'item_name', 'payment_id',
            'order_id', "payment_number",
        ];
