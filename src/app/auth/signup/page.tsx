...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | PowerPals - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page PowerPals Dashboard Template",
  // other metadata
};
