...
export const metadata: Metadata = {
  title: "Next.js Profile | PowerPals - Next.js Dashboard Template",
  description:
    "This is Next.js Profile page for PowerPals - Next.js Tailwind CSS Admin Dashboard Template",
};

const Profile = () => {
  return (
    <DefaultLayout>
      <div className="mx-auto max-w-290.5">
        <Breadcrumb pageName="Map" />

        <div className=" rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="relative z-20 h-60 md:h-65">
              <iframe
            src="https://solar-potential-kypkjw5jmq-uc.a.run.app/"
            width="100%"
            height="800px"
            style={{ border: 0 }}
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            <div className="relative z-30 mx-auto -mt-22 h-100 w-full max-w-30 rounded-full p-1 backdrop-transparent sm:h-44 sm:max-w-44 sm:p-3">
